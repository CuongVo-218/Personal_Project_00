                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="mb-3">
                                ...
                                <input name="title" id="title" type="text" class="form-control" require placeholder="tên trang đơn">
                            </div>
                            <div class="mb-3">
                                <label for="detail">Chi tiết trang đơn</label>
                                <textarea name="detail" id="detail" class="form-control" required required placeholder=""></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="type">Kiểu bài viết</label>
                                <textarea name="type" id="type" class="form-control" required required placeholder="page"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="metadesc">Mô tả</label>
                                <textarea name="metadesc" id="metadesc" class="form-control" required required placeholder=""></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="metakey">Từ khoá</label>
                                <textarea name="metakey" id="metakey" class="form-control" required required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
